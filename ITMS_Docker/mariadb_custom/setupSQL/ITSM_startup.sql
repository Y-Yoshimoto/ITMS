...
INSERT INTO t_incidentdata VALUES (1, '情報基盤', 1, 'Nginx停止', 'リバースプロキシ用のnginx.serviceが停止','サービスの再起動で復旧', '経過観察中','2019-10-04 15:25:07', '2019-10-05 18:25:22', 2, 0);
INSERT INTO t_incidentdata VALUES (2, '情報基盤', 1, 'MySQL停止', '冗長系への切り替わりが発生。2号機で運用継続中','','' , '2019-10-02 22:25:23', '2019-10-07 18:22:45', 4, 0);
INSERT INTO t_incidentdata VALUES (3, '情報基盤', 1, 'CPUリソース上昇', 'APサーバ1号機でCPU使用率上昇(90%)','', '', '2019-10-02 22:26:14', '2019-10-02 22:26:14', 3, 0);
